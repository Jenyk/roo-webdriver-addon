...
public class WebdriverOperationsImpl implements WebdriverOperations {
    ...
    public void annotateType(JavaType javaType) {
        ...
        if (existing != null && MemberFindingUtils.getAnnotationOfType(existing.getAnnotations(), new JavaType(RooWebdriver.class.getName())) == null) {
            ...
            JavaType rooRooWebdriver = new JavaType(RooWebdriver.class.getName());

            // Create Annotation metadata
            AnnotationMetadataBuilder annotationBuilder = new AnnotationMetadataBuilder(rooRooWebdriver);
    ...
    public void setup() {
        ...
        projectOperations.addRepository("", new Repository("Webdriver Roo add-on repository", "Webdriver Roo add-on repository", "https://roo-webdriver-addon.googlecode.com/svn/repo"));
        
        List<Dependency> dependencies = new ArrayList<Dependency>();
        
        // Install the dependency on the add-on jar (
        dependencies.add(new Dependency("cz.bcp.roo.selenium.webdriver", "cz.bcp.roo.selenium.webdriver", "0.1.0.BUILD-SNAPSHOT", DependencyType.JAR, DependencyScope.PROVIDED));
